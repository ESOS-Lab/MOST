...
#define MOST_SDCARD //ANY USE. Temporary files should be mentioned in the Linux kernel blktrace module.
//#define NUXUS_S_PART1 //NEXUS_S PARTITION 1
...
#if defined NUXUS_S_PART1

#define PARTITION_NAME "/dev/block/mmcblk0p1"
...
int debugfs_open_filesystem()
{
	...
	open_filesystem(PARTITION_NAME, open_flags,
			superblock, blocksize, catastrophic,
			data_filename);
}
